  ...
  @include('site.layouts.navbar')
      <div class="container" id="" style="margin-top:6.9rem;height: auto;min-height: 260px">
          <section class="row ltr">
              ...
              <div class="card col-md-3 d-none d-md-block p-0" style="background: rgb(235, 231, 223) none repeat scroll 0% 0% / cover;direction: rtl;text-align: right">
...
<script>
    ...
    //     $('#messageNavigation').remove("left-zero");
    // },3500);
    setTimeout(function () {
